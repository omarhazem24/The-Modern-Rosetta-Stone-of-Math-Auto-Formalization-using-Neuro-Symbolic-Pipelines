...
\begin{figure}[H]
    ...
    \IfFileExists{img/python_script_screenshot.png}{
        \includegraphics[width=0.8\textwidth]{img/python_script_screenshot.png}
    }{
        \fbox{\begin{minipage}[c][4cm][c]{0.8\textwidth}\centering Image: Python Script Interface (Placeholder, place 'python\_script\_screenshot.png' in img/ folder)\end{minipage}}
    }
