...
\vspace{0.5cm}
\begin{center}
\lstinputlisting[language=Python, frame=single, caption={Core Prompt Logic from \texttt{llm\_translator.py}}, label={lst:python_script}, firstline=14, lastline=37, basicstyle=\ttfamily\scriptsize]{scripts/llm_translator.py}
\end{center}
\vspace{0.5cm}
